...
<tr><th><h1>Search for any student either by admission or name any can do..</h1></th></tr>
<tr><td> <p>From this form you can make several searches in all the streams from  form one to form four all the information is provided on this page. Once you have entered the name you want to find press the search button and you will be able to view a detailed record  </p>       </td>     </tr>
<tr><td></td>     </tr>
<tr><td></td>     </tr>
<tr><td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Search for any student by Admission.<input type="text" name="search" value="" id="search" size="70"><input type="submit" value="search" id="submit"></td></tr>
<tr><td></td>     </tr>
<tr><td></td>     </tr>
<tr><td></td>     </tr>
<tr><td>
