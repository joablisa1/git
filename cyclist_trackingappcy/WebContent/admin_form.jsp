...
<br><br><br><br>
<h1 align="center">Please Only the administrator has access and authority to login from this side thank.</h1>
<form action="login_servlet.jsp" method="post" name="form1" id="regifrom" onsubmit="return required()">
...
<tr><td colspan="2" align="center"><input type="submit" value="Administrator" id="submit" size="45"></td></tr>
<tr><td colspan="2">                       
